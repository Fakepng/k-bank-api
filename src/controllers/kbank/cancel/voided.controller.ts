...
import { CancelQRVoided } from "../../../utils/kbank/cancel/voided.util";

async function cancelQRVoided(req: Request, res: Response) {
  ...
  const data = await CancelQRVoided(request, access_token);
